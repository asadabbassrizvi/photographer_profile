...
import "./PortraitPhotography.scss";

function PortraitPhotgraphy() {
  useEffect(() => {
    const item = document.querySelectorAll(".serStaricImg");
    const tl = gsap.timeline({ repeat: -1 }); // Setting repeat to -1 makes it loop infinitely
    // Add the rotation animation to the timeline
    tl.to(item, { duration: 3, rotation: -360, ease: "none" });
    // Start the animation
    tl.play(0);
  }, []);
        ...
        <div className="ppRate">
          ...
          <div className="dealsContainer">
            ...
            <div className="dealsMain">
              ...
              <span>
                Copy Includes a 2-hour photoshoot and 20 professionally edited
                images
              </span>
            </div>
            ...
            <div className="dealsMain">
              ...
              <span>Additional images can be purchased at $10 each.</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="ppRate">
          ...
          <div className="dealsContainer">
            ...
            <div className="dealsMain">
              ...
              <span>
                Includes a 3-hour photoshoot and 30 professionally edited
                images.
              </span>
            </div>
        ...
        <div className="ppRate">
          ...
          <div className="dealsContainer">
            ...
            <div className="dealsMain">
              ...
              <span>
                Includes a 2.5-hour photoshoot and 25 professionally edited
                images.
              </span>
            </div>
...
export default PortraitPhotgraphy;
