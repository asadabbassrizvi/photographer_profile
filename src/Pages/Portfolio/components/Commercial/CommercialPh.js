...
import carousel1 from "../images/Image7.png";
import carousel2 from "../images/Image8.png";
import carousel3 from "../images/Image9.png";
import "./CommercialPh.scss";

function CommercialPh() {
  return (
    <div className="serContainer carouselBlock">
      <div className="headingPh">
        <div className="text">
          <h4 className="ph_font">Commercial Photography</h4>
        </div>
