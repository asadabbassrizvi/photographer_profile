...
import carousel1 from "../images/Image6.png";
import carousel2 from "../images/Image5.png";
import carousel3 from "../images/Image4.png";
import "./EventPh.scss";
  ...
  return (
    <div className="serContainer carouselBlock">
      <div className="headingPh">
        <div className="text">
          <h4 className="ph_font">Event Photography</h4>
        </div>
